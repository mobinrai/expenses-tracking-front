...
const Register = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-gray-100 justify-center min-h-lvh ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 shadow-lg w-full max-w-sm p-4 border border-gray-300">
                ...
                <div>
                    <button type="submit" className="border border-primary-500 bg-primary-500 py-1 cursor-pointer text-black font-bold hover:bg-white hover:text-primary-500 w-full">Register</button>
                </div>
